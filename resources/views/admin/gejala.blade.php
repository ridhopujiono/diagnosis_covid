        ...
        <div class="col-12">
            <div class="card table-content">
                <div class="card-header">
                    <h4 class="card-title">Manajemen Gejala</h4>
                </div>
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('detail_edit_gejala')}}/{{$d->id}}" class="badge rounded-pill bg-secondary">detail / edit</a>
                                ...
                                <div class="">
                                    <div class="container">
                                        <div class="row p-4">
                                            ...
                                            <form action="{{url('input_gejala')}}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="">Kode Gejala</label>
                                                    <input type="text" class="form-control" name="kode" placeholder="Isikan Kode Gejala">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Nama Gejala</label>
                                                    <input type="text" class="form-control" name="nama" placeholder="Isikan Nama Gejala">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Pertanyaan</label>
                                                    <input type="text" class="form-control" name="pertanyaan" placeholder="Isikan Pertanyaan ">
                                                </div>
