                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('detail_edit_knowledge')}}/{{$d->id}}" class="badge rounded-pill bg-secondary">detail / edit</a>
                                ...
                                <div class="">
                                    <div class="container">
                                        <div class="row p-4">
                                            ...
                                            <form action="{{url('input_knowledge')}}" enctype="multipart/form-data" method="POST">
                                                @csrf


                                                <div class="form-group">
                                                    <label for="">IF</label>
                                                    <textarea type="text" class="form-control" name="if" rows="3"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">THEN</label>
                                                    <textarea type="text" class="form-control" name="then" rows="3"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">IF NOT THEN</label>
                                                    <textarea type="text" class="form-control" name="if_not_then" rows="3"></textarea>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn-hapus").on("click", (e) => {
            ...
            let url = "{{url('delete_knowledge')}}/" + id;
