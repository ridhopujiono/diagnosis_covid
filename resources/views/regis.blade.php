                ...
                <div id="auth-left">
                    ...
                    <form action="{{url('regis')}}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="tetx" class="form-control form-control-xl" placeholder="Nama Lengkap" name="name">
                        ...
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-2" style="background-color: #15253d;" type="submit">Simpan</button>
                    </form>
                    <div class="text-center mt-3 text-lg fs-6">
                        <p class="text-gray-600">Sudah punya akun ? <a href="{{url('/')}}" class="font-bold">Login</a>.</p>
