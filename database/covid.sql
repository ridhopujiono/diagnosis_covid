...
INSERT INTO `gejala` (`id`, `kode`, `nama`, `pertanyaan`, `created_at`, `updated_at`) VALUES
(2, '002', 'PILEK', 'Apakah pilek termasuk gejala ?', NULL, NULL);
...
CREATE TABLE `penyakit` (
  ...
  `pengendalian` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'admin', 'admin@gmail.com', NULL, '$2y$10$98h9SMUHMbEY9uJNUMzSzebgBzb0gNSuq84CUiKY/fEmfH3JnjUd.', 'admin', NULL, NULL, NULL),
(2, 'Test', 'test@gmail.com', NULL, '$2y$10$fY5zcZo57ceTDwiVIVtzV.JFtaM3ydRjzWMX6czBJut7xmrvgYGxm', 'user', NULL, NULL, NULL),
(3, 'Test 2', 'test2@gmail.com', NULL, '$2y$10$uWbK4FZhJPvP/a/OLXZvC.gkhz315Os9LXv7cn6Y7kEQfPHc3oWUe', 'user', NULL, NULL, NULL);
